                ...
                addSaveButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (germanInput.isEmpty() || englishInput.isEmpty()) {
                            ...
                            listGerman(german, new File("/FOIT_2123_Java/src/a_11FOIT/vi_listen/vi_xxxx/germanGUI.txt"));
                            english.add(addEnglishField.getText());
                            listEnglish(english, new File("/FOIT_2123_Java/src/a_11FOIT/vi_listen/vi_xxxx/englishGUI.txt"));
